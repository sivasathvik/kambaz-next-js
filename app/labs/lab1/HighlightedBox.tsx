  ...
  return (
    <div id="wd-highlighted-box">
      ...
      >
        ...
        <p>My three goals for this course:</p>
        <ul>
          <li>Get comfortable building React components and passing props.</li>
          <li>Learn to connect a Next.js front end to a real back end API.</li>
          <li>Deploy a full stack project I can show on my resume.</li>
        </ul>
      </HighlightedBox>
    </div>
  );
